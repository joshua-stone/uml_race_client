...
void chatterCallback(const sensor_msgs::LaserScan::ConstPtr& msg)
{
	...
	angular.z = 10.0 * (msg->ranges[0] - msg->ranges[msg->ranges.size() - 1]);
	linear.x = 1;
	linear.y = 0;
	linear.z = 0;
  ...
  ROS_INFO("I heard linear x-value: [%f]", speed.linear.x);
  ROS_INFO("I heard angular y-yalue: [%f]", speed.angular.y);
